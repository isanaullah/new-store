...
$pages = [
    ...
    [
        'title' => 'About Us',
        'slug' => 'about-us',
        'meta_desc' => 'Learn more about our company, mission, and vision.',
        'page_name' => 'About Us',
    ...
    [
        'title' => 'Blog Show',
        'slug' => 'blog-show',
        'meta_desc' => 'Read individual blog posts and articles.',
        'page_name' => 'Blog Show',
    ...
    [
        ...
        'meta_desc' => 'Browse through our full range of products.',
        'page_name' => 'Product Listing',
        'page_desc' => 'This page displays all products.',
        'status' => 1,
    ],
    [
        'title' => 'Product Show',
        'slug' => 'product-show',
        'meta_desc' => 'View details of a single product.',
        'page_name' => 'Product Show',
        'page_desc' => 'This page displays product details.',
        'status' => 1,
    ],
    [
        'title' => 'Disclaimer',
        'slug' => 'disclaimer',
        'meta_desc' => 'Read our website disclaimer and legal notices.',
        'page_name' => 'Disclaimer',
        'page_desc' => 'This is the disclaimer page.',
        'status' => 1,
    ],
    [
        'title' => 'Cart',
        'slug' => 'cart',
        'meta_desc' => 'Read our website Cart and legal notices.',
        'page_name' => 'Cart',
        'page_desc' => 'This is the Cart page.',
        'status' => 1,
    ],
    [
        'title' => 'Privacy-Policy',
        'slug' => 'privacy-policy',
        'meta_desc' => 'Read our website Privacy-Policy and legal notices.',
        'page_name' => 'Privacy-Policy',
        'page_desc' => 'This is the Privacy-Policy page.',
        'status' => 1,
    ],
    [
        'title' => 'Cancellation Policy',
        'slug' => 'cancellation',
        'meta_desc' => 'View our cancellation policy and terms.',
        'page_name' => 'Cancellation',
        'page_desc' => 'This is the cancellation policy page.',
        'status' => 1,
    ],
    [
        'title' => 'Track Orders',
        'slug' => 'track-orders',
        'meta_desc' => 'Track the status of your orders online.',
        'page_name' => 'Track Orders',
        'page_desc' => 'This is the track orders page.',
        'status' => 1,
    ],
    [
        'title' => 'Return Policy',
        'slug' => 'return-policy',
        'meta_desc' => 'Read our return and refund policy.',
        'page_name' => 'Return Policy',
        'page_desc' => 'This is the return policy page.',
        'status' => 1,
    ],
];
